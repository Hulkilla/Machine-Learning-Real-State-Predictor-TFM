...
modelo_ann = joblib.load("modelo_ann/modelo_ann.pkl")
scaler_entrada_ann = joblib.load("modelo_ann/standardscaler_datos_entrada.pkl")
scaler_precio_ann = joblib.load("modelo_ann/standardscaler_precio.pkl")

modelo_xgb = joblib.load("modelo_ml/modelo_xgb.pkl")
scaler_entrada_xgb = joblib.load("modelo_ml/standardscaler_datos_entrada.pkl")
scaler_precio_xgb = joblib.load("modelo_ml/standardscaler_precio.pkl")
...
def predict_xgb():
    ...
    try:
        ...
        return jsonify({"prediccion xgb": float(pred)})
...
def predict_ann():
    ...
    try:
        ...
        return jsonify({"prediccion ann": float(pred)})
